...
/**
 * Test case for class Tx_Blsvspstbauantrag_Controller_AntragsanforderungController.
 *
 * @version $Id$
 ...
 */
class Tx_Blsvspstbauantrag_Controller_AntragsanforderungControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
