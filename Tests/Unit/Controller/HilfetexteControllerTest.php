...
/**
 * Test case for class Tx_Blsvspstbauantrag_Controller_HilfetexteController.
 *
 * @version $Id$
 ...
 */
class Tx_Blsvspstbauantrag_Controller_HilfetexteControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
