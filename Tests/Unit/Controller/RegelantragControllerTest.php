...
/**
 * Test case for class Tx_Blsvspstbauantrag_Controller_RegelantragController.
 *
 * @version $Id$
 ...
 */
class Tx_Blsvspstbauantrag_Controller_RegelantragControllerTest extends Tx_Extbase_Tests_Unit_BaseTestCase {
	/**
